...
async function api(path, options = {}) {
    ...
    const response = await fetch(`${'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVwd3NjYWJveHBseG12d2x1bW9jIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODE0MDA3MjMsImV4cCI6MjA5Njk3NjcyM30.lRX-kLjdaAgJIcyMu42qdqMmcb7_ypDg-rYBCpxMDQ0sb_publishable_hfJbvypQih4CDhOzemqpUA_vNQW5Eam'}${path}`, { ...options, headers });
